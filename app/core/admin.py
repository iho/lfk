...
from .models import Personal, User, PersonalIndexPage, Comment, MenuItem, HomeTopMenuItem, HomeFooterMenuItem, HomePage, DefaultPage, License, ServiceIndexPage, ServicePage, Action, Comments, Social


class PersonalAdmin(admin.ModelAdmin):
    list_display = ('id', 'fio', 'text', 'position', 'image')
...
class DefaultPageAdmin(admin.ModelAdmin):
    ...
    search_fields = ('slug',)
admin.site.register(DefaultPage, DefaultPageAdmin)
